...
include_once(__DIR__ . "/KontrakPresenterPembalap.php");
...
class PresenterPembalap implements KontrakPresenterPembalap
{
    ...
    public function initListPembalap()
    {
        ...
        // Buat objek pembalap dan simpan di list pembalap
        $this->listPembalap = [];
